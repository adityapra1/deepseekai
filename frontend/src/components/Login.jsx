...
// 1. Apna BACKEND_URL import karna mat bhoolna! (Aapne apni nayi utils file mein jo banaya hai us se)
import { BACKEND_URL } from "../utils/utils"; // Path apne hisaab se check kar lena
...
function Login() {
  ...
  const handleLogin = async () => {
    ...
    setError("");
    try {
      // 2. Hardcoded URL ki jagah yahan variable ka istemaal kiya hai
    ...
    <div className="min-h-screen flex items-center justify-center bg-black px-4">
      <div className="bg-[#1e1e1e] text-white w-full max-w-md rounded-2xl p-6 shadow-lg">
        ...
        <div className="flex justify-between mt-4 text-sm">
          {/* 3. 'a' tag ko 'Link' se replace kiya */}
